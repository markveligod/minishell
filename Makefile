...
#    Updated: 2020/07/25 20:25:03 by ckakuna          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
HDRS = ./minish.h
SRCS = ./minish.c ./srcs/error.c ./srcs/parser_echo.c ./srcs/line_space.c ./srcs/line_parse.c ./srcs/parser_base.c ./srcs/line_space_counter.c
